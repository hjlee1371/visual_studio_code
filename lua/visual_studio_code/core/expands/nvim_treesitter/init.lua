...
function M.get_highlight(conf, colors)
    return {
        ...
        ["@constant"] = { fg = colors.__vscode_constant },
        ...
        ["@include"] = { fg = colors.__vscode_control },
